...
namespace IndieStudio.DrawingAndColoring.Logic
{
	...
	public class ShapesTable1 : MonoBehaviour
	{
			/// <summary>
			...
			/// The shapes list.
			/// </summary>
			public static List<TableShape1> shapes;
			...
			void Start ()
			{
					...
					if (saveLastSelectedGroup && ShapesManager1.instance!=null) {
						scrollSlider.currentGroupIndex = ShapesManager1.instance.lastSelectedShape;
					}
			}
			...
			public void OnChangeGroup (int currentGroup)
			{
					if (saveLastSelectedGroup) {
						ShapesManager1.instance.lastSelectedShape = currentGroup;
					}
			}
	}
}